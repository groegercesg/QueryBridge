...
def run_query(sql, constants):
    ...
    # Run this query
    cmd = ["python3", constants.CONVERTER_LOC, '--file', constants.INPUTS_DIR+constants.QUERY_NAME, "--output_location", constants.OUTPUTS_DIR, '--benchmarking', "False", "--name", constants.OUTPUT_NAME, "--db_file", "../../postgres_connection.json"]    
