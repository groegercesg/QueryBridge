...
df_filter_5 = df_filter_5[['p_partkey', 'p_name', 'p_mfgr', 'p_brand', 'p_type', 'p_size', 'p_container', 'p_retailprice', 'p_comment']]
df_filter_6 = region[region.r_name == 'EUROPE']
df_filter_6 = df_filter_6[['r_regionkey', 'r_name', 'r_comment']]
df_filter_7 = nation[['n_nationkey', 'n_name', 'n_regionkey', 'n_comment']]
df_merge_4 = df_filter_6.merge(df_filter_7, left_on="r_regionkey", right_on="n_regionkey")
df_merge_4 = df_merge_4[['n_name', 'n_nationkey']]
df_filter_8 = supplier[['s_suppkey', 's_name', 's_address', 's_nationkey', 's_phone', 's_acctbal', 's_comment']]
df_merge_5 = df_merge_4.merge(df_filter_8, left_on="n_nationkey", right_on="s_nationkey")
...
df_sort_1 = df_merge_6.sort_values(by=['ps_partkey'], ascending=[True])
df_sort_1 = df_sort_1[['s_acctbal', 's_name', 's_address', 's_phone', 's_comment', 'ps_partkey', 'ps_supplycost', 'n_name']]
df_merge_7 = df_filter_5.merge(df_sort_1, left_on="p_partkey", right_on="ps_partkey")
df_merge_7 = df_merge_7[['s_acctbal', 's_name', 'n_name', 'p_partkey', 'p_mfgr', 's_address', 's_phone', 's_comment']]
df_sort_2 = df_merge_7.sort_values(by=['s_acctbal', 'n_name', 's_name', 'p_partkey'], ascending=[False, True, True, True])
df_sort_2 = df_sort_2[['s_acctbal', 's_name', 'n_name', 'p_partkey', 'p_mfgr', 's_address', 's_phone', 's_comment']]
df_limit_1 = df_sort_2[['s_acctbal', 's_name', 'n_name', 'p_partkey', 'p_mfgr', 's_address', 's_phone', 's_comment']]
